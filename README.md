<p align="center">
  <h1 align="center">🖐️ 3D_Hand_2</h1>
...
```text
上位机 ──UART──▶ STM32 ──PWM×5──▶ SG90 舵机 ──▶ 🖐️ 灵巧手
```
...
- **舵机供电**：5~6V 独立电源，共地（⚠️ 禁止从 STM32 板载 5V 取电）
...
```text
Host ──UART──▶ STM32 ──PWM×5──▶ SG90 Servos ──▶ 🖐️ Hand
```
...
- **Servo Power**: 5~6V external supply, common GND (⚠️ do NOT use STM32 onboard 5V)
